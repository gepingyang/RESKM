...
%%%  visualize 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%  
Deq = [U_o;U_a;C_o;C_a;C_o_pai];
[pc,score,latent,tsquare] = pca(Deq);
U_o  = score(1:n,1:2);
U_a = score(n +1: n + a,1:2);

C_o = score(n + a + 1: n + a + K,1:2);
C_a = score(n + a +K +1:n + a+K+K,1:2);
C_o_pai = score(n+a + K +K +1: n + a + K +K +K, 1:2);  
    for eee = 1:a
