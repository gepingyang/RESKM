...
numRep = 10;  % Number of times to repeat the clustering of anchor k-means, each with new set of initial centroids.
...
%step 4: Perform kmeans
    tic;
    [labels,center]=litekmeans(U_a,K,'MaxIter',100,'Replicates',numRep);
...
time_construct_avg = time_construct_avg;
